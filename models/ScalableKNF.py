...
class SKNF(nn.Module):
    ...
    def __init__(self,
        ...
        #     d_model=latent_dim * num_feats + self.len_interas,
        #     nhead=1,
        #     dim_feedforward=transformer_dim
        # )
        # self.temporal_transformer = nn.TransformerEncoder(
        #     self.temporal_transformer_layer,
        #     num_layers=1
        # )
        # self.positional_encoder = PositionalEncoding3D(
        #     d_model=latent_dim * num_feats + self.len_interas,
        #     max_seq_len=w
        # )
    ...
    def single_forward(
        ...
        # trans_out = self.positional_encoder(trans_out.transpose(1, 2))
        # trans_out = self.temporal_transformer(trans_out)
